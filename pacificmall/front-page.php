<?php get_header(); ?>
    ...
    ?>
        ...
        <div class="section-buttons">
          ...
          <?php echo $shop_title; ?>一覧を見る</button>
        </div>
      </div>
    </section>
    <section class="section-contents" id="contribution">
      ...
      ?>
          ...
          <article class="article-card">
            <a class="card-link" href="<?php the_permalink(); ?>">
              <div class="card-inner">
                <div class="card-image"> <?php the_post_thumbnail('front-contriution'); ?> </div>
                <div class="card-body">
        ...
        <div class="section-buttons">
          ...
          <?php echo $contribution_title;  ?>を見る</button>
        </div>
      </div>
    </section>
    ...
    <section class="section-contents" id="company">
      ...
      ?>
        ...
        <div class="section-buttons">
          ...
          '<?php echo esc_url (home_url('company')); ?>';">
         <?php the_title(); ?> 一覧を見る
          </button>
        </div>
